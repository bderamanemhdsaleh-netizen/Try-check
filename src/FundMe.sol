...
contract FundMe {
     ...
     * they are executed locally/off-chain when called externally
     * but they cost gas when called internally (i.e. from another function)
     * they are executed on-chain when called internally
     */
